...
if (isset($_POST['send'])) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'nadinezairi60@gmail.com'; // Replace with your Gmail email
        $mail->Password = 'wxfv yjmk udqt lltr';   // Replace with your Gmail app password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        // Set sender and recipient
        $mail->setFrom('nadinezairi60@gmail.com', 'Nadine zairi');
