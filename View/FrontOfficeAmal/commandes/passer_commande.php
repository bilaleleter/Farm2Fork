...
$nom = $user['nom_consomateur'];
$prenom = $user['prenom_consomateur'];
$email = $user['email'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['produit'], $_POST['quantite'], $_POST['submit']) && !empty($_POST['produit']) && !empty($_POST["quantite"])) {
  ...
  if($commandeController->addCommande($commande)){

    echo "Commande passée avec succès !";
    header('Location: \Farm2Fork MAIN BRANCH\Integration\View\FrontOfficeBilel\index.php');
...
<body>
  ...
  <body>
    <main class="container my-5">
      ...
      <form id="commandeForm" action="" method="POST" class="row g-3" autofill="false" autocomplete="false">
        <!-- Informations Client -->
        <section>
          <h2>Informations Client</h2>
          <div class="col-md-6">
            <label for="nom" class="form-label">Nom :</label>
            <input type="text" id="nom" name="nom" class="form-control" value="<?php echo $nom?>" disabled>
            <small class="text-danger d-none" id="nomError">Le nom ne doit contenir que des lettres et des
              espaces.</small>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <small class="text-danger d-none" id="telephoneError">Le numéro de téléphone doit contenir entre 8 et 12
              chiffres.</small>
          </div>
        </section>
        ...
        <div id="cart-items">
          ...
          $total = 0;
          $liste = $produitcontroller->listeProduit(null, '');
            ...
            foreach ($_SESSION['panier'] as $id_produit => $quantite) {
              ...
              if ($produit) {
                ...
                <div class='d-flex justify-content-between align-items-center mb-2'>
                    <img src='\Farm2Fork MAIN BRANCH\Integration\View/BackOfficeBilel/{$produit['image_produit']}' alt='{$produit['nom_produit']}' style='width: 50px; height: auto; margin-right: 10px;'>
        ...
        <?php if (!empty($_SESSION['panier'])): ?>
          ...
          <div class="col-12">
            <button type="submit" name="submit" class="w-100 btn btn-primary btn-lg mt-3">Passer la Commande</button>
          </div>
          <div class="mt-3">
            <!-- Boutons -->
            <a href="\Farm2Fork MAIN BRANCH\Integration\View\FrontOfficeBilel\index.php"
              ...
              <i class="bi bi-trash3-fill me-2" style="font-size: 20px;"></i> Retour au Panier
            </a>
          </div>
        <?php endif; ?>
      </form>
