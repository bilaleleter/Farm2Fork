...
include_once __DIR__ . "/../../../Controller/ProduitControllerAmal.php";
        ...
        <div class="col-md-6 col-lg-4 p-4 rounded shadow" style="background-color: #ffffff; border: 2px solid #408c148d;">
            ...
            <form action="" method="post">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn" style="background-color: #4fa579; color: #ffffff; border: none;">Modifier la Commande</button>
                </div>
            </form>
        </div>
    </section>
