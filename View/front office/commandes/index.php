...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $statut_de_livraison = $_POST['statut_de_livraison'];
  $date_de_livraison_estimee =  date('Y-m-d H:i:s', strtotime('+7 days'));
  $livraison = new \Model\Livraison(0, $ville, $codePostal, $Adresse, $date_d_envoi, $statut_de_livraison, $date_de_livraison_estimee);
...
<body>
  ...
  <div class="card" style="width: 18rem;">
    <img src="https://tse3.mm.bing.net/th?id=OIP.Y8JVBi1-gD33iXg92quuLAHaFW&pid=Api&P=0&h=180" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Produit 1</h5>
      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
      <a href="/projetweb/projetweb/View/front%20office/commandes/passer_commande.php" class="btn btn-primary">Commander</a>
    </div>
  </div>
  <div class="card" style="width: 18rem;">
    <img src="https://tse3.mm.bing.net/th?id=OIP.Y8JVBi1-gD33iXg92quuLAHaFW&pid=Api&P=0&h=180" class="card-img-top" alt="...">
...
<style>
  ...
  <script>
    ...
    const checkFormValidity = () => {
      const villeValid = villeInput.value.trim() !== '';
      const codePostalValid = /^\d{4}$/.test(codePostalInput.value.trim());
      const adresseValid = adresseInput.value.trim() !== '';
    ...
    codePostalInput.addEventListener('input', () => {
      const regex = /^\d{4}$/; // Valide un code postal de 4 chiffres
      if (!regex.test(codePostalInput.value.trim())) {
        codePostalError.textContent = "Veuillez entrer un code postal valide (4 chiffres).";
