              ...
              <form id="commandeForm" action="" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    placeholder="Ville"
                    required>
                  <small id="villeError" class="text-danger d-none">La ville est obligatoire.</small>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    required
                    pattern="\d{4}">
                  <small id="codePostalError" class="text-danger d-none">Veuillez entrer un code postal valide (4 chiffres).</small>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    placeholder="Adresse"
                    required>
                  <small id="adresseError" class="text-danger d-none">L'adresse est obligatoire.</small>
                </div>
