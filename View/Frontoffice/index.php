        ...
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            ...
            <div class="d-flex gap-3">
              ...
              <a href="../Backoffice/ajout.php"  class="btn btn-dark text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Ajouter un Produit</a>
            </div>
            <table border="1" style="border-collapse: collapse; width: 100%; margin-top: 20px;">
  <thead style="background-color: #f2f2f2; text-align: center;">
    <tr>
      <th style="padding: 10px; font-size: 16px; color: #333;">Nom du produit</th>
      <th style="padding: 10px; font-size: 16px; color: #333;">Image du produit</th>
      <th style="padding: 10px; font-size: 16px; color: #333;">Description du produit</th>
      <th style="padding: 10px; font-size: 16px; color: #333;">Prix du produit</th>
      <th style="padding: 10px; font-size: 16px; color: #333;">Quantité du produit</th>
      <th style="padding: 10px; font-size: 16px; color: #333;">Stock du produit</th>
    </tr>
  </thead>
  <tbody style="text-align: center; color: #444;">
    <?php
    foreach ($liste as $produit) {
    ?>
    <tr style="background-color: #fafafa; border-bottom: 1px solid #ddd; transition: background-color 0.3s ease;">
      <td style="padding: 8px;"><?= $produit['nom_produit'] ?></td>
      <td>
        <img src="../Backoffice/<?= $produit['image_produit'] ?>" 
             alt="<?= $produit['nom_produit'] ?>" 
             style="width: 150px; height: auto; border-radius: 8px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
      </td>
      <td style="padding: 8px;"><?= $produit['description_produit'] ?></td>
      <td style="padding: 8px;"><?= $produit['prix'] ?></td>
      <td style="padding: 8px;"><?= $produit['quantite_produit'] ?></td>
      <td style="padding: 8px;"><?= $produit['stock_produit'] ?></td>
    </tr>
    <?php
    }
    ?>
