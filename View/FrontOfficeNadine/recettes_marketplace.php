            ...
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="pages">
                  ...
                  <li><a href="affiche.php" class="dropdown-item">Recettes </a></li>
        ...
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            ...
            <div class="d-flex gap-3">
              ...
              <a href="#"  class="btn btn-dark text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Ajouter un Produit</a>
            </div>
            <div class="row my-5">
              <div class="col">
                            ...
                            <?php foreach ($recipes as $recipe): ?>
                                <div class="swiper-slide">
                                    <div class="recipe">
                                        ...
                                        <!-- Link to Details -->
                                        <a href="affiche.php?id=<?= htmlspecialchars($recipe['idr']); ?>" class="details-link">Détails</a>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
