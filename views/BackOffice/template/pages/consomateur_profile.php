        ...
        <div class="row gx-4 mb-2">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="<?php echo htmlspecialchars($user['profile_pic']) ?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm" />
            </div>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-8">
                    <ul class="list-group">
                      ...
                      <li class="list-group-item border-0 ps-0 text-sm">
                        <strong class="text-dark">Phone:</strong> (+<?php echo htmlspecialchars($user['country']); ?>)
